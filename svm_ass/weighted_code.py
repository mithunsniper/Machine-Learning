...
svc =SVC(kernel='rbf', gamma=optg,C=optc,class_weight='balanced')
start=time.time()
...
svc =SVC(kernel='linear',C=optc,class_weight='balanced')
start=time.time()
svc.fit(x_train,y_trainlabel)
end=time.time()
...
optp=opt[0][0]
optg=opt[0][3]
svc = SVC(kernel='poly',C=optc,degree=optp,gamma=optg,class_weight='balanced')
start=time.time()
svc.fit(x_train,y_trainlabel)
end=time.time()
print("training time",end-start)
...
svc =SVC(kernel='sigmoid',C=optc,gamma=optg,coef0=optco,class_weight='balanced')
start=time.time()
svc.fit(x_train,y_trainlabel)
end=time.time()
print("training time",end-start)
